...
public class ScoresController {
    ...
    @PostMapping("player")
    public ResponseEntity<?> addScore(@RequestBody ScoreModel scoreRequest) {
    ...
    public ResponseEntity<?> updateScore( @PathVariable Long id, @RequestParam int newScore) {
        try {
    ...
    @Tag(name = "delete", description = "delete method to delete a player")
    @DeleteMapping("/scores/{id}")
    public ResponseEntity<?> deletePlayerAndScore(@PathVariable Long id) {
